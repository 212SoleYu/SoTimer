...
uint32_t energy_raw = 0;                                // pt-method 计算出的能耗值
...
//        time_off = regression(energy_consumption,time_on);            // 用于实际部署和验证
        time_off = energy_consumption;                                  // 用于测量

//        time_on = energy_consumption;                                 // 用于实际部署和验证
